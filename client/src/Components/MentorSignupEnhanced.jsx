  ...
  const validateStep = (currentStep) => {
    ...
    if (currentStep === 1) {
      ...
      if (formData.expertise.length === 0)
        newErrors.expertise = "Select at least one skill";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        passingYear:
          new Date().getFullYear() - parseInt(formData.yearsOfExperience),
      };

      console.log("Sending Payload of Mentor:", payload);
                  ...
                  <React.Fragment key={stepConfig.id}>
                    <div className="flex flex-col items-center gap-2 shrink-0">
                      <motion.div
                        ...
                        animate={{
                          scale: step === stepConfig.id ? [1, 1.1, 1] : 1,
                        }}
                      >
                        <Icon size={20} />
                      </motion.div>
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <AnimatePresence mode="wait">
              ...
              {step === 1 && (
                ...
                >
                  <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                    <Briefcase className="text-purple-400" /> Professional
                    Background
                  </h2>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      {AVAILABILITY_OPTIONS.slice(0, 6).map(
                        ({ day, slots }) => (
                          <div
                            key={day}
              ...
              {step === 3 && (
                ...
                >
                  <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                    <CheckCircle className="text-purple-400" /> Review Your
                    Profile
                  </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <ReviewSection title="Basic Profile">
                      ...
                      <ReviewItem
                        label="LinkedIn"
                        value={
                          formData.linkedinUrl ? "Provided" : "Not provided"
                        }
                      />
                    </ReviewSection>
                    ...
                    <ReviewSection title="Professional">
                      ...
                      <ReviewItem
                        label="Experience"
                        value={`${formData.yearsOfExperience} years`}
                      />
                      <ReviewItem
                        label="Skills"
                        value={
                          formData.expertise.slice(0, 3).join(", ") +
                    ...
                    <ReviewSection title="Mentorship">
                      <ReviewItem
                        label="Areas"
                        value={
                          formData.mentorshipAreas.slice(0, 2).join(", ") +
                          (formData.mentorshipAreas.length > 2 ? "..." : "")
                        }
                      />
                      <ReviewItem
                        label="Languages"
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <label htmlFor="terms" className="text-sm text-white/80">
                      ...
                      commit to providing quality mentorship to students.
                    </label>
                  </div>
                  {errors.terms && (
  ...
  <div>
    ...
    <div className="relative">
      ...
      <input
        ...
        className={`w-full ${
          Icon ? "pl-12" : "pl-4"
        } pr-4 py-3 rounded-xl bg-white/5 border-2 ${
