...
const AuthPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const loginEndpoints = [
      ...
      {
        url: `${API_URL}/recruiter/login`,
        role: "recruiter",
        redirect: "/recruiter-profile",
      },
      {
        url: `${API_URL}/mentor/login`,
        role: "mentor",
      ...
      <div className="w-full max-w-md bg-white/70 backdrop-blur-md border border-purple-100 rounded-3xl shadow-2xl p-6 sm:p-8">
        ...
        <button className="w-full py-2 border border-indigo-400 text-indigo-600 rounded-lg flex items-center justify-center space-x-2 hover:bg-indigo-50 transition">
          <svg className="w-5 h-5" viewBox="0 0 533.5 544.3">
            <path
              fill="#4285F4"
              d="M533.5 278.4c0-18.3-1.5-36-4.4-53.2H272v100.8h146.9c-6.3 34-25 62.9-53.2 82.2v68h85.8c50.2-46.3 79-114.6 79-197.8z"
            />
            <path
              fill="#34A853"
              d="M272 544.3c71.8 0 132.1-23.6 176.1-64.2l-85.8-68c-23.8 16-54.2 25.5-90.3 25.5-69.3 0-128-46.7-149.1-109.6h-88.5v68.7c44 87 133 148.6 237.6 148.6z"
            />
            <path
              fill="#FBBC05"
              d="M122.6 337.7c-10.1-30.3-10.1-62.8 0-93.1v-68.7h-88.5c-38.5 75-38.5 163.4 0 238.4l88.5-68.7z"
            />
            <path
              fill="#EA4335"
              d="M272 107.2c37 0 70.1 12.7 96.3 33.8l72.2-72.2C404.1 24 343.8 0 272 0 167.4 0 78.4 61.6 34.4 148.6l88.5 68.7C144 153.9 202.7 107.2 272 107.2z"
            />
          </svg>
