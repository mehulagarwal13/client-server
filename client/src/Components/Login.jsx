...
const AuthPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex justify-center items-start pt-10 pb-10 bg-gradient-to-b from-[#F8F7FF] to-white px-4 overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/70 backdrop-blur-md border border-purple-100 rounded-3xl shadow-2xl p-6 sm:p-8">
        ...
        <div className="flex justify-center mb-6 bg-gray-100 rounded-full p-1">
          <button className="flex-1 text-center py-2 rounded-full font-medium bg-indigo-500 text-white shadow-sm">
            Login
          </button>
          <button
            onClick={handleSignUpTab}
            className="flex-1 text-center py-2 rounded-full font-medium text-gray-600 hover:bg-gray-200"
          >
            Sign Up
          </button>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition"
            />

            <button
              type="button"
              onClick={togglePassword}
              className="absolute right-3 top-[50px] -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-gray-100 rounded-full shadow-sm text-gray-500 hover:text-indigo-500"
            >
              {showPassword ? (
        ...
        <button className="w-full py-2 border border-indigo-400 text-indigo-600 rounded-lg flex items-center justify-center gap-2 hover:bg-indigo-50 transition">
